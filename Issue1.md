...
FAILED - RETRYING: Wait for node to report ready (1 retries left). 
FAILED - RETRYING: Wait for node to report ready (1 retries left). 
fatal: [l2-51-router1.lab2.dslee.lab]: FAILED! => {"attempts": 36, "changed": false, "cmd": ["oc", "get", "node", "l2-51-router1.lab2.dslee.lab", "--kubeconfig=/root/.kube/kubeconfig", "--output=jsonpath={.status.conditions[?(@.type==\"Ready\")].status}"], "delta": "0:00:00.133377", "end": "2021-03-09 03:16:41.033440", "rc": 0, "start": "2021-03-09 03:16:40.900063", "stderr": "", "stderr_lines": [], "stdout": "False", "stdout_lines": ["False"]} 
fatal: [l2-61-log1.lab2.dslee.lab]: FAILED! => {"attempts": 36, "changed": false, "cmd": ["oc", "get", "node", "l2-61-log1.lab2.dslee.lab", "--kubeconfig=/root/.kube/kubeconfig", "--output=jsonpath={.status.conditions[?(@.type==\"Ready\")].status}"], "delta": "0:00:00.126709", "end": "2021-03-09 03:16:41.790622", "rc": 0, "start": "2021-03-09 03:16:41.663913", "stderr": "", "stderr_lines": [], "stdout": "False", "stdout_lines": ["False"]} 
fatal: [l2-52-router2.lab2.dslee.lab]: FAILED! => {"attempts": 36, "changed": false, "cmd": ["oc", "get", "node", "l2-52-router2.lab2.dslee.lab", "--kubeconfig=/root/.kube/kubeconfig", "--output=jsonpath={.status.conditions[?(@.type==\"Ready\")].status}"], "delta": "0:00:00.126476", "end": "2021-03-09 03:16:42.025740", "rc": 0, "start": "2021-03-09 03:16:41.899264", "stderr": "", "stderr_lines": [], "stdout": "False", "stdout_lines": ["False"]} 
TASK [openshift_node : Gather Debug - Get service status] **************************************************************** 
ok: [l2-61-log1.lab2.dslee.lab] => (item=cri-o) 
ok: [l2-51-router1.lab2.dslee.lab] => (item=cri-o) 
ok: [l2-52-router2.lab2.dslee.lab] => (item=cri-o) 
ok: [l2-61-log1.lab2.dslee.lab] => (item=kubelet) 
ok: [l2-52-router2.lab2.dslee.lab] => (item=kubelet) 
ok: [l2-51-router1.lab2.dslee.lab] => (item=kubelet) 
TASK [openshift_node : Gather Debug - Get complete node objects] ********************************************************* 
ok: [l2-51-router1.lab2.dslee.lab] 
ok: [l2-52-router2.lab2.dslee.lab] 
ok: [l2-61-log1.lab2.dslee.lab] 
TASK [openshift_node : DEBUG - Node failed to report ready] ************************************************************** 
fatal: [l2-51-router1.lab2.dslee.lab]: FAILED! => {"changed": false, "msg": "Node failed to report ready"} 
fatal: [l2-52-router2.lab2.dslee.lab]: FAILED! => {"changed": false, "msg": "Node failed to report ready"} 
fatal: [l2-61-log1.lab2.dslee.lab]: FAILED! => {"changed": false, "msg": "Node failed to report ready"} 
PLAY RECAP *************************************************************************************************************** 
l2-51-router1.lab2.dslee.lab : ok=40   changed=29   unreachable=0    failed=1    skipped=8    rescued=1    ignored=0    
l2-52-router2.lab2.dslee.lab : ok=40   changed=29   unreachable=0    failed=1    skipped=8    rescued=1    ignored=0    
l2-61-log1.lab2.dslee.lab  : ok=40   changed=29   unreachable=0    failed=1    skipped=8    rescued=1    ignored=0    
